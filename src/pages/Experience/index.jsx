...
export default function Experience() {
    ...
    <>
      {elements.map((element) => (
        <img
          ...
          style={{
            left: `${element.left}%`,
            animation: `fallIcon ${element.duration}s linear ${element.delay}s infinite`,
          }}
        />
      ))}
    </>
  ...
  return (
    <>
      <div className="skill grid md:grid-cols-3 grid-cols-1 gap-4 transform -translate-y-16">
        {/* LIBRARY Card */}
